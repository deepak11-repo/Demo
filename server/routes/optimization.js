...
const { getNewH1 } = require("../controllers/newOptimizeH1");
...
const{ getMainUrl } = require("../controllers/optimizeMainUrl");

router.get("/title", getTitle);
router.get("/meta", getMetaDescription);
router.get("/newH1", getNewH1);
router.get("/h2", getH2);
router.get("/h3", getH3);
router.get("/h4", getH4);
router.get("/h5", getH5);
