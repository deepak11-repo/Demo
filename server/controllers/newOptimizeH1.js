const { extractH1Headers, checkH1, optimizeSingleH1, optimizeMultipleH1, generateH1 } = require('../utility/newH1');

const getNewH1 = async (req, res) => {
    try {
