...
import { setAnchorLoading, setH1Loading, setH2Loading, setH3Loading, setH4Loading, setH5Loading, setH6Loading, setImageLoading, setLinkLoading, setMetaLoading, setParagraphLoading, setTitleLoading, setUrlLoading } from '../../utility/loaderSlice';
...
const MainTab = () => {
    ...
    const { url, primaryKeywords, secondaryKeywords, titleResponse, metaResponse, h1Response, h2Response, h3Response, h4Response, h5Response, h6Response, paragraphResponse, imageResponse, anchorResponse, urlResponse, linkResponse } = useSelector((state) => state.inputs);
    
    const { urlLoading, titleLoading, metaLoading, h1Loading, h2Loading, h3Loading, h4Loading, h5Loading, h6Loading, paragraphLoading, imageLoading, anchorLoading, linkLoading } = useSelector((state) => state.loader);
          ...
          if (url && primaryKeywords && secondaryKeywords) {
            try {
              ...
              const dispatchActions = [
                ...
                { action: () => getNewH1(url, primaryKeywords), responseSetter: setH1Response, loadingSetter: setH1Loading },
                ...
                { action: () => getLinks(url), responseSetter: setLinkResponse, loadingSetter: setLinkLoading },
              ];
                ...
                <div className="flex flex-col items-center w-[15%] overflow-hidden text-gray-400 bg-gray-900 rounded">
                    ...
                    <div className="w-full px-2">
                        <div className="flex flex-col items-center w-full mt-3 border-t border-gray-700">
                            ...
                            {/* Internal Links */}
                            <div
                                className={`flex items-center justify-between w-full h-12 px-3 mt-2 mb-5 rounded hover:bg-gray-700 hover:text-gray-300 cursor-pointer ${getItemClassName('Links')}`}
